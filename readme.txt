...
= 1.5 =
*** Your settings may be lost. If this is an issue, please back-up your options file before upgrading! ***

Added some environment checks and outputs to help troubleshoot issues with SafeMode and directory permissions. Also added support for Comments and Pings, reformatted the Admin Panel and completed many code optimizations.